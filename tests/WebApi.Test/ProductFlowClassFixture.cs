...
public class ProductFlowClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;
    
    public ProductFlowClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
